<%@ Page Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Icon.aspx.cs" Inherits="MyCms.Admins.Icon" %>
...
<style type="text/css">
      ...
      .tab-content .fa{ font-size:25px}
      .tab-content .col-md-3 {margin-bottom:10px;}
    </style>
        <section class="content-header"><h1> Quản lý Icon</h1></section><section class="content"><div class="row"><div class="col-xs-12"><div class="box adm1"> 
