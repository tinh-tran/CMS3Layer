<%@ Page Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ImagesList.aspx.cs" Inherits="MyCms.Admins.ImagesList" %>
               ...
               .foo{ text-align:left}
                    ...
                    <div class="panel-body">
                        <div class="dataTable_wrapper">
                            <asp:DataGrid PageSize="12" ID="grdListImg" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover"
                                AutoGenerateColumns="False" AllowPaging="True" PagerStyle-Mode="NumericPages"
                                PagerStyle-HorizontalAlign="Center" OnItemDataBound="grdListImg_ItemDataBound"
                                OnItemCommand="grdListImg_ItemCommand" 
                                OnPageIndexChanged="grdListImg_PageIndexChanged">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundColumn DataField="Name" HeaderText="Tên hình ảnh" Visible="true" ItemStyle-CssClass="boxleft">
<ItemStyle CssClass="boxleft"></ItemStyle>
                                    </asp:BoundColumn>
                                    ...
                                    <asp:TemplateColumn ItemStyle-CssClass="Function">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" Text='<%#DataBinder.Eval(Container.DataItem, "Summary").ToString()%>'
                                                runat="server" />
                                        </ItemTemplate>
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <br />
                                    <input class='btn btn-default' id="btnImgImage" type="button" onclick="BrowseServer('<% =txtImage.ClientID %>','testimg');"
                                        value=" Chọn Tệp tin " />
